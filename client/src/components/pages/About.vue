  ...
  <div id="about" v-on:scroll="reportPosition">
    ...
    <section id="qa3">
      <header>
        ...
        <h3>As a generalist designer, I can move into any part of the product lifecycle.</h3>
        <h3>Very commonly, I'm brought into the early stages of initiatives to help build the product vision, then curate the process from interface designs through engineering implementation.</h3>
      </header>
    </section>
    <section id="qa4">
      <header>
    ...
    <section id="qa5">
      <header>
        <h1>Your photo is pretty ridiculous. I hope you don't take yourself that seriously.</h1>
        <h3>Yes, the photo is a joke, albeit a poorly implemented one. One of my favorite films of all time is Blade Runner, which challenges what it means to be human and how technology can go towards extending that humanity.</h3>
        ...
        <h3>So, maybe I do take myself too seriously? 🤔</h3>
      </header>
    </section>
    <section id="qa6">
      <header>
        ...
        <h3>Sketch via
          <a href="https://goabstract.com" target="_blank">Abstract</a> for general UI and brand exploration/organization with <a href="https://pasteapp.com/p/wd2tW2xdxuw" target="_blank">Paste</a> and <a href="https://www.pinterest.com/cbeasley0/2018-personal-brand-exploration-v4/" target="_blank">Pinterest</a>.</h3>
      </header>
    </section>
    <section id="qa_end">
      <header>
