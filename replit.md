...
I prefer simple language in explanations. I like functional programming. I want iterative development. Ask before making major changes. I prefer detailed explanations.
...
| File | Purpose |
|------|---------|
| `ask/client/src/pages/chat.tsx` | SSE handling, `preResponsePrompt` state, renders disambiguation |
| `ask/client/src/components/follow-up-card.tsx` | Topic chip component |
| `ask/server/routes.ts` | `isBroadQuery()`, `getFollowUpSuggestions()`, SSE emission |
