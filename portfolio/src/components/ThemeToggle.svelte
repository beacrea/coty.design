...
>
  {#if isDark}
    <svg class="icon moon" aria-hidden="true" viewBox="3 -1 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {:else}
    <svg class="icon sun" aria-hidden="true" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
