...
export const siteContent = {
  ...
  familyExplainer: {
    ...
    description: "Cornered at the grocery store? Need to explain what I do and \"I think he does something with computers\" isn't cutting it? This AI translates my work into plain English.",
