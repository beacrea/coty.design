...
export const siteContent = {
  opener: {
    ...
    summary:
      "I define how complex products fit together, aligning strategy, AI behavior, workflows, and interface rules so platforms scale without losing\u00A0clarity.",
  },
  ...
  advisory: {
    ...
    framing:
      "Drawing on two decades across infrastructure, fintech, and AI\u00A0systems, I occasionally take on a small number of advisory and speaking\u00A0engagements.",
    items: [
    ...
    items: [
      {
        ...
        url: "https://linkedin.com/in/cbeasley0",
      },
      {
        text: "GitHub",
        description: "for code and collaborations",
        url: "https://github.com/beacrea",
      },
      {
        text: "Advisory &\u00A0speaking",
        description: "inquiries via LinkedIn",
        url: "https://linkedin.com/in/cbeasley0",
      },
