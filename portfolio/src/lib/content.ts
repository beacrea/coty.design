...
export const siteContent = {
  ...
  familyExplainer: {
    ...
    description: "Cornered at Thanksgiving? Neighbors asking questions? Need to explain what I do to someone who thinks I \"fix computers\"? This AI translates my work into plain English.",
