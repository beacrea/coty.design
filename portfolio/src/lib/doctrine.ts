...
export function getStatusColor(status: string): { bg: string; fg: string; dot: string } {
  const colors: Record<string, { bg: string; fg: string; dot: string }> = {
    ...
    'Supported': { bg: 'oklch(0.90 0.05 132)', fg: 'oklch(0.30 0.12 132)', dot: 'oklch(0.50 0.20 132)' },
    'Strongly supported': { bg: 'oklch(0.91 0.06 112)', fg: 'oklch(0.28 0.14 112)', dot: 'oklch(0.47 0.22 112)' },
